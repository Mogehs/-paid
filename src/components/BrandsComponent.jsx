        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <div>
            <ul className="space-y-2 text-norap">
              ...
              <li>
                <Link to="/brands#match" className="text-[#878683] text-[12px]">
                  Match with creators
                </Link>
              </li>
              <li>
                <Link
                  to="/how-it-works#manage"
                  className="text-[#878683] text-[12px]"
                >
              ...
              <li>
                <Link to="/" className="text-black text-[12px] font-bold">
                  TEAMS
                </Link>
              </li>
              <li>
                <Link to="/brands" className="text-[#878683] text-[12px]">
                  Marketers
                </Link>
              </li>
              <li>
                <Link to="/agencies" className="text-[#878683] text-[12px]">
                  Agencies
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1 mt-4 text-norap">
              ...
              <li>
                <Link
                  to="/collaborating-on-a-compaign"
                  className="text-[#878683] text-[12px]"
                >
                  Managing campaigns
                </Link>
              ...
              <li>
                <Link to="/getting-paid" className="text-[#878683] text-[12px]">
                  Campaign results
                </Link>
              </li>
              <li>
          ...
          {/* Column 4 */}
          <div>
            <h3 className="text-black font-bold text-[12px] mt-[40px]">
              EVENTS
            </h3>
            <ul className="space-y-1 text-norap">
              ...
              <li>
                <Link
                  to="/creator-marketing-summit-north"
                  className="text-[#878683] text-[12px]"
                >
              ...
              <li>
                <Link to="/" className="text-black font-bold text-[12px]">
                  CASE STUDIES
                </Link>
              </li>
              <li>
                <Link to="/education" className="text-[#878683] text-[12px]">
                  Education
                </Link>
              </li>
              <li>

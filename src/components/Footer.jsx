...
const Footer = () => {
  return (
    <footer className="bg-[#000000] text-white py-10 px-5 md:px-20 rounded-t-3xl">
      <h1 className="bg-white text-black flex py-9 px-9 justify-center items-center rounded-[40%] text-6xl font-bold w-12 h-12">
        #
      </h1>
      {/* 5 Columns */}
      <div className="flex justify-center items-center mt-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 b">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-700 hover:text-gray-500 font-bold transition">
                CREATORS
              </li>
              <li>
                <Link
              ...
              <li>
                <Link
                  to={"/"}
                  className="text-gray-700 hover:text-gray-500 font-bold transition"
                >
                  Brands{" "}
                </Link>
              </li>
        ...
        <div className="hidden lg:block">
          <div className="bg-white text-black p-6 rounded-[8%] shadow-md md:w-[30vw] md:h-[35vw] hover:bg-[#e4dada]">
            <h3 className="text-md text-gray-400 font-semibold mb-2 text-start">
              COUNTRY HARVEST
            </h3>
      ...
      <div className="mt-10 flex flex-wrap gap-3 justify-start items-center">
        <div className="flex">
          <img
            src="/Footer/fotter2.png"
            alt="Image 1"
            className="w-38 h-12 object-cover"
          />
        </div>
        <div className="flex">
          <img src="/Footer/fotter3.png" alt="Image 2" className="w-20 h-24 " />
        </div>
        <div className="flex">
          <img src="/Footer/fotter4.png" alt="Image 3" className="w-20 h-24" />
        </div>
        <div className="flex">
          <img
            src="/Footer/fotter5.png"
            alt="Image 4"
            className="w-20 h-20 object-cover"
          />
        </div>
        <div className="flex">
          <img src="/Footer/footer6.svg" alt="Image 5" className="w-40 h-24" />
        </div>
      </div>

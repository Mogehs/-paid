...
const cards = [
  {
    ...
    heading:
      "Driving consideration and enrollment of a top American University",
    imgSrc: "/education/img-1.png",
    category: "Education",
  },
  {
          ...
          {filteredCards.map((card, index) => (
            <div key={index} className="md:w-[22rem] md:h-full md:mt-0 mt-4">
              <div className="bg-[#f2f0eb] rounded-3xl flex flex-col md:p-6 p-4 h-full">
                ...
                <div className="heading">
                  <h3 className="font-bold text-[1.125rem] mt-5">
                    {card.heading}
                  </h3>
                </div>
